...
function sendMail(){
	(function() {
		emailjs.init("user_Px6GASmq6Yw6BGPUImYOZ");
		})();
  ...
  if(isNonValid(nam)&&isNonValid(maile)&&isNonValid(message)){
   if(!emailIsValid(maile)){
	...
	toastbody.style.color = "#ff0000";
		 ...
		 emailjs.send("service_xsimfxu","template_cl2z897",{
		to_name: nam.value,
		from_name: maile.value,
  ...
  /** **/
  function EmptyThem (v1,v2,v3,v4){
	v1.value="";
	v2.value="";
	 v3.value="";
	 v4.value="";
	...
	function isNonValid(valu){
	  if(valu.value==null||valu.value==""){
		return false
